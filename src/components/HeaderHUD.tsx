    ...
    <header className="w-full sticky top-0 z-40 backdrop-blur-xl bg-slate-950/70 border-b border-white/10 transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-3 flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-sm font-bold tracking-tight text-white flex items-center gap-1.5">
                <span className="hidden xs:inline">HIT ANNOUNCER</span>
                <span className="xs:hidden">HITS</span>
          ...
          {/* Center Actions: Search Trigger & Language Switcher */}
              ...
              {LANGUAGES.map((lang) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-2 sm:px-3 py-1 rounded-full text-xs font-medium transition-all ${
                      isSelected
